  ...
  return <div className="container mx-auto py-8">
      ...
      <div id="invoice-printable" className="bg-white p-8 rounded-lg shadow">
        <div className="flex justify-between items-center mb-8">
          <div>
            <img src="https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/over-work-98o8wz/assets/k8h0x3i2mmoy/logo_wide_transparent_black_writing.png" alt="OVERCODE" className="h-12" />
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div>
            ...
            {invoice.clientContact && <p className="text-sm text-gray-500">{invoice.clientContact}</p>}
          </div>
          <div className="text-right">
            <div className="mb-2">
        ...
        <div className="flex justify-end">
          <div className="w-1/3">
            ...
            {(isPartiallyPaid || isPaid) && <div className="mt-2">
                <div className="flex justify-between pb-2">
                  <span className="font-medium">Paid:</span>
                  <span className="text-green-600">{formatCurrency(invoice.amountPaid || 0, invoice.currency)}</span>
                </div>
                {!isPaid && <div className="flex justify-between pt-2 border-t border-gray-200">
        ...
        {invoice.payments && invoice.payments.length > 0 && <div className="mt-8 pt-4 border-t border-gray-200">
            ...
            <table className="w-full">
              ...
              <tbody>
                {invoice.payments.map(payment => <tr key={payment.id} className="border-b border-gray-100 text-sm">
