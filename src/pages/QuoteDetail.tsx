...
import { ArrowLeft, Edit, FileText, Calendar, DollarSign, User, Mail, Printer, Receipt } from "lucide-react";
...
const QuoteDetail = () => {
  ...
  const handleConvertToInvoice = async () => {
    ...
    try {
      ...
      // Save to Firestore using the firebase helper
      const { firestore } = await import('@/lib/firebase');
      await firestore.createInvoice(newInvoice);
  ...
  return (
    <>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button onClick={handleConvertToInvoice} variant="outline" className="flex items-center">
      ...
      <div className="printable-area max-w-4xl mx-auto bg-white p-8">
        <div className="mb-8">
          <img 
