...
export const useProjectForm = (project: Project | null, projectId?: string) => {
  ...
  const initializeFormData = (projectData: Project) => {
    setFormData({
      ...
      source_excel_file: (projectData as any).source_excel_file || null,
      source_excel_balances: (projectData as any).source_excel_balances || null,
      ...
      evaluation_approval_documents_files: (projectData as any).evaluation_approval_documents_files || (projectData as any).sentinel_approval_email_files || [],
      ...
      component_reporting_applicable_auditing_standards: (projectData as any).component_reporting_applicable_auditing_standards || '',
      component_reporting_applicable_auditing_standards_other: (projectData as any).component_reporting_applicable_auditing_standards_other || '',
      component_reporting_applicable_financial_framework: (projectData as any).component_reporting_applicable_financial_framework || '',
      component_reporting_applicable_financial_framework_other: (projectData as any).component_reporting_applicable_financial_framework_other || '',
      component_reporting_date: (projectData as any).component_reporting_date || '',
      group_audit_report_date: (projectData as any).group_audit_report_date || '',
      required_component_closeout_date: (projectData as any).required_component_closeout_date || '',
      independence_rules_iesba: (projectData as any).independence_rules_iesba || false,
      independence_rules_iesba_non_pie: (projectData as any).independence_rules_iesba_non_pie || false,
    ...
    procedure_nature: (projectData as any).procedure_nature || '',
    procedure_type: (projectData as any).procedure_type || '',
    procedure_frequency: (projectData as any).procedure_frequency || '',
    operator_authority: (projectData as any).operator_authority || '',
    information_used: (projectData as any).information_used || '',
    eval_inquiry: (projectData as any).eval_inquiry || false,
    eval_inspection: (projectData as any).eval_inspection || false,
    eval_observation: (projectData as any).eval_observation || false,
    eval_procedures_documentation: (projectData as any).eval_procedures_documentation || '',
    design_conclusion: (projectData as any).design_conclusion || '',
    implementation_conclusion: (projectData as any).implementation_conclusion || '',
    plan_operating_test: (projectData as any).plan_operating_test || '',
    di_rafit_rows: (projectData as any).di_rafit_rows || [{ id: 1, rafit: '', itLayer: '', howAddresses: '' }],
    di_operator_rows: (projectData as any).di_operator_rows || [{ id: 1, role: '', authority: '' }],
      ...
      // Comptes à pouvoir fields
      comptesaPouvoir_rawtc_impact: (projectData as any).comptesaPouvoir_rawtc_impact || false,
      comptesaPouvoir_rawtc_deficiencies: (projectData as any).comptesaPouvoir_rawtc_deficiencies || false,
      comptesaPouvoir_rawtc_infrequent: (projectData as any).comptesaPouvoir_rawtc_infrequent || false,
      comptesaPouvoir_rawtc_competence: (projectData as any).comptesaPouvoir_rawtc_competence || false,
      comptesaPouvoir_rawtc_complex: (projectData as any).comptesaPouvoir_rawtc_complex || false,
      comptesaPouvoir_rawtc_prior_deficiencies: (projectData as any).comptesaPouvoir_rawtc_prior_deficiencies || false,
      comptesaPouvoir_rawtc_changes: (projectData as any).comptesaPouvoir_rawtc_changes || false,
      comptesaPouvoir_rawtc_judgments: (projectData as any).comptesaPouvoir_rawtc_judgments || false,
      comptesaPouvoir_rawtc_other: (projectData as any).comptesaPouvoir_rawtc_other || false,
      comptesaPouvoir_rawtc_significant: (projectData as any).comptesaPouvoir_rawtc_significant || '',
      comptesaPouvoir_assessed_rawtc: (projectData as any).comptesaPouvoir_assessed_rawtc || '',
      comptesaPouvoir_procedures: (projectData as any).comptesaPouvoir_procedures || [],
      comptesaPouvoir_procedures_description: (projectData as any).comptesaPouvoir_procedures_description || '',
      comptesaPouvoir_period_start: (projectData as any).comptesaPouvoir_period_start || '',
      comptesaPouvoir_period_end: (projectData as any).comptesaPouvoir_period_end || '',
      comptesaPouvoir_extent_description: (projectData as any).comptesaPouvoir_extent_description || '',
      comptesaPouvoir_internal_info: (projectData as any).comptesaPouvoir_internal_info || '',
      comptesaPouvoir_sample_size: (projectData as any).comptesaPouvoir_sample_size || '',
      comptesaPouvoir_increased_sample: (projectData as any).comptesaPouvoir_increased_sample || false,
      comptesaPouvoir_unpredictability: (projectData as any).comptesaPouvoir_unpredictability || false,
      comptesaPouvoir_sampling_tool: (projectData as any).comptesaPouvoir_sampling_tool || false,
      comptesaPouvoir_generate_template: (projectData as any).comptesaPouvoir_generate_template || false,
      comptesaPouvoir_attach_documentation: (projectData as any).comptesaPouvoir_attach_documentation || false,
      comptesaPouvoir_deviations: (projectData as any).comptesaPouvoir_deviations || '',
      comptesaPouvoir_test_result: (projectData as any).comptesaPouvoir_test_result || '',
      comptesaPouvoir_period_result: (projectData as any).comptesaPouvoir_period_result || '',
      ...
      comptesAPouvoir_gitc_rawtc_assessment: (projectData as any).comptesAPouvoir_gitc_rawtc_assessment || '',
      comptesAPouvoir_timing_procedures: (projectData as any).comptesAPouvoir_timing_procedures || '',
      comptesAPouvoir_extent_procedures: (projectData as any).comptesAPouvoir_extent_procedures || '',
      comptesAPouvoir_sample_size: (projectData as any).comptesAPouvoir_sample_size || '',
      comptesAPouvoir_test_operating_effectiveness: (projectData as any).comptesAPouvoir_test_operating_effectiveness || false,
      ...
      high_risk_criteria_items: (projectData as any).high_risk_criteria_items || [],
